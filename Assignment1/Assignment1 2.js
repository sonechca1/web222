...
 * other students.
 * 
 * Name: _Damian_Murawiecki_ Student ID: _121531164_ Date: _September 15, 2017_
 *
 ******************************************************************************/
...
console.log(largerNum(123,321));
console.log(greaterNum(3, 35));
console.log(greaterNum(900,600));

// C part: (new, optional)

function largestNum() {

  var largestNumValue = 0;
  for (var i = 0; i < arguments.length; ++i) {
    if (arguments[i] > largestNumValue) {
      largestNumValue = arguments[i];
    }
  }
  return largestNumValue;
}

console.log(largestNum(70,50,6));
console.log(largestNum(70,500,6));
console.log(largestNum(70,50,600));
